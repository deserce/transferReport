...
At this point, it is convenient to formalize notation used in defining defects to supplement further explanation.
...
Charge is described using the superscripts \ch{S^*} and \ch{S'} to represent positive and negative charges respectively. The number of times the superscript is repeated corresponds to the magnitude of the charge.
...
This can either indicate the defect is present at a regular lattice site, in which case the chemical symbol of the species which occupies the site is given (\ch{H,~ He,~ Li,~ \ldots}), or indicate the defect is in the interstitial space, indicated by the subscript $i$.
