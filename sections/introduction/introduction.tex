...
\begin{labeling}{\textbf{Redox well}}
	...
	A structure with excess Li must then be charge compensated by either some metal sites undergoing a \ce{M^n -> M^{n+2}} transition, or other redox active species must be involved in the charge compensation process.	
\end{labeling}
In particular, the charge compensation by O-redox have been observed in many systems.\cite{Li2018a}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{figures/structures/Li2MnO3}
