...
In order to decrease \ce{CO2} emissions and limit the impact of global warming, a shift from fossil-fuel based energy generation towards renewable energy is vital.\cite{Goodenough2013}
...
The electrochemical performance of a battery is a function of both the manufacturing processes used, and its constituent materials.
The following sections give an overview of the materials used as the main components of batteries, both in commercial cells and those materials that are of research interest.
As cathodes are the focus of this work, these are discussed in greater detail.
...
\label{fig:LCO}
\end{figure}
\ce{LiMO2} adopt \ce{\alpha-NaFeO2} structures (Figure \ref{fig:LCO}), which is the prototype structure of \ce{AMO2} layered cathode materials, where M is typically \ce{Co}, \ce{Ni}, and/or \ce{Mn}.
The structure is comprised of alternating layers of \ce{[MO2]-} and \ce{Li+} layers ($R\bar{3}M$).\cite{Islam2014}
...
Nevertheless, a number of issues exist with \ce{LiCoO2} cathodes.
...
\paragraph{\ce{LiMnO2}} 
The similarity of the ionic radii of high-spin \ce{Mn^3+} (\SI{0.65}{\angstrom}) and \ce{Li+} (\SI{0.76}{\angstrom}) prevents the formation of stable layered \ce{LiMnO2}.\cite{Rozier2015,Rossen1992}
...
\paragraph{\ce{Co^3+}}
The addition of \ce{Co^3+} stabilises \ce{Ni^3+} at elevated temperatures, minimising the formation of \ce{Ni^2+}.
...
\paragraph{\ce{Al^3+}} \ce{Al^3+} cations occupy M sites in the \ce{MO2} layers.
...
\caption{Key properties of \ce{Li[Ni_{1-y-z}Mn_yCo_z]O2} as a function of metals ratio.\cite{Rozier2015, Noh2013} Numbers in brackets indicate the ratio of \ce{Ni}:\ce{Mn}:\ce{Co}.} 
\label{fig:NMCcomp}
\end{figure}
...
\subsection{\ce{LiMn2O4} spinel}
Despite its relatively low capacities (\SI{140}{\milli\ampere\hour\per\gram}), \ce{LiMn2O4} spinel has found some commercial success in applications requiring high discharge rates.
Low internal resistance, arising from the 3 dimensional ion conduction pathways, allow for rapid cycling at high currents.

Whilst pure \ce{LiMn2O4} batteries are uncommon, they are commonly coupled with NMC cathodes in EV applications, with the NMC component providing larger capacities, and the \ce{LiMn2O4} component enabling for short periods of high current discharge, as required during rapid acceleration.
...
It exhibits an O3-type monoclinic structure, with an ordered (honeycomb) distribution of \ce{Li+/Mn^4+} ions in the mixed \ce{[Li_{1/3}Mn_{2/3}]O2} layer.\cite{Rozier2015}
Initially thought to be electrochemically inactive due to the already fully oxidised \ce{Mn^4+}, \ce{Li2MnO3} was later shown to  demonstrate a huge theoretical capacity of \SI{285}{\milli\ampere\hour\per\gram}.\cite{Thackeray2005, Chen2016b}
...
\caption{Evolution of \ce{Li[LiNiMnCo]O2} from \ce{LiCoO2}.\cite{Rozier2015}} 
...
As with the \ce{LiMO2} cathodes, the rich chemistry associated with the presence of multiple metal species offers a wide range of compositions and provides scope to overcome some of the issues associated with the current state of the art Li-rich cathodes, such as voltage fade and O-loss.\cite{Rozier2015}
...
Diaz-Lopez \textit{et al.}\cite{Diaz-Lopez2018} characterised the material, demonstrating that a \ce{MnO} rock-salt structure with high \ce{Li/Mn} disorder at cationic sites, and 1/\nth{6} O vacancies at the anionic site provided good agreement with synchrotron and powder diffraction data.
...
\paragraph{\ce{Li2MnO2F}}
Initially presented by Bruce \textit{et al.},\cite{House2018} \ce{Li2MnO2F} also exhibits disorder on both the cation and anion sites.
...
Despite the promise of disordered rock-salts as next-generation cathode materials, there has been little focus on the defect chemistry or migration mechanisms of \ce{Li4Mn2O5} in the literature.
...
The highly disordered nature of \ce{Li4Mn2O5} is expected to give rise to a number of barriers to study not encountered in conventional ordered systems.
...
\begin{enumerate}
	\item Model the structural characteristics of \ce{Li4Mn2O5} using atomistic techniques
	...
	\item Identify the limitations of conventional methods arising due to the highly disordered nature of \ce{Li4Mn2O5} to inform future method development
\end{enumerate}