...
Work done by experimental collaborators has indicated the possibility of O/Cl exchange in \ce{Li3OCl}, but no previous work has yet examined this phenomenon.
...
A nine month block in Figure \ref{fig:gantt} has been left open, allowing for the findings of previous studies and upcoming literature to be reflected in the area of research focus in the latter stages of the PhD.
...
%   progress label text={},
    ...
    \ganttmilestone[inline=false]{Poster: IMLB Conference}{10} \\
	...
	\ganttmilestone[inline=false]{Talk: RSC Xmas Meeting}{15} \\
	
	\ganttgroup[inline=false]{Material TBC}{11}{19}\\ 
	\ganttmilestone[inline=false]{Talk: MRS Spring Meeting}{19} \\
