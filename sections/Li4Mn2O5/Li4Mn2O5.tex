...
\centering
 ...
 \end{subfigure}
  \begin{subfigure}{\textwidth}
   \centering
    \includegraphics[height=0.4\textheight]{figures/structures/random_final_compressed}
    \caption{Relaxed structure}
...
This study has used well-established atomistic modelling techniques to provide atomic scale insights into the energetics of defect formation and lithium ion migration in \ce{Li4Mn2O5}.
...
\begin{itemize}
	\item Structural modelling can be performed using either the mean-field approximation or ordered approximations of \ce{Li4Mn2O5}, but purely random structure generation does not reproduce the observed rock-salt structure.
	...
	\item Neither random structure generation nor the use of ordered approximations of disordered \ce{Li4Mn2O5} adequately recreates the isotropic and low-energy percolation networks of lithium diffusion pathways characteristic of disordered rock-salt cathode materials.
