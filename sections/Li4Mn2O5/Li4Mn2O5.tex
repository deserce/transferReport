...
Rather than a random series of percolation paths as would be expected in a disordered rock-salt, the ordered structure consists of alternating Li1/Li2 and Li5/Li6 grids, connected by Li3/Li4 bridges. 
...
Figure \ref{fig:msd1000} shows the MSD of the system at 1000K, split into ion motion in Li1/Li2 and Li3/Li4 planes (planar) and diffusion onto and between sites 3 and 4 (interlayer).
There is clear anistropy, with no interlayer diffusion, which poorly replicates the expected isotropic diffusion characteristic of disordered rock-salts.
Further, the planar diffusion rate is very low considering the high temperatures of this simulation.
