...
In the absence of prior information regarding the energetics or stability of given local environments, nor a means of procedurally generating and analysing said environments, structures must instead be randomly generated.
Twenty such structures were produced, half containing 216 atoms and the other half containing 1728 atoms (to conserve stoichiometry), with each site randomly assigned an atom in accordance with the occupancy of that site.
