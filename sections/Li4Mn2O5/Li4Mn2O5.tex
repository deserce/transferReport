...
\begin{table}[h]
\centering
\caption{Isolated defect energies for the formation of vacancies in \ce{Li4Mn2O5} in eV.}
...
\begin{table}[h]
\centering
\caption{Isolated defect energies for interstitial defects in \ce{Li4Mn2O5} in eV. Sites 1, 2 and 3 refer interstices, whilst sites V1 and V2 refer to vacant O sites.}
...
\end{table}
\noindent
Tables \ref{tab:schottky} and \ref{tab:frenkel} show the formation energies of Schottky and Frenkel defects in \ce{Li4Mn2O5}.
...
\caption{MSD plots of lithium ion diffusion through 10\% delithiated \ce{Li4Mn2O5} at a range of temperatures.}
\label{fig:msdall}
\end{figure}
