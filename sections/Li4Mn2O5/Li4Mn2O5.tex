...
The potential parameters used to study this system were taken from past work in the literature on lithium manganese oxides by \citet{Ammundsen1999}, and are listed in Table \ref{tab:potentials}, although the mean-field approximation necessitates the use of a rigid-ion model.
...
No oxygen or manganese mobility was observed over the 10 ns period.
\begin{figure}[p]
\centering
