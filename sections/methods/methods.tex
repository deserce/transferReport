...
The mean square displacement (MSD) measures the distance each atom has moved from its position at time zero, or more commonly, time zero with trajectory information from the equilibration period discarded.
...
By calculating the diffusion coefficient associated with all the particles of a given species, the self-diffusion coefficient of that species is then given by:
\begin{equation}
	MSD_t = 2dDt
\end{equation}
