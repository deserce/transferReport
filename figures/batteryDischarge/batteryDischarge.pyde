...
def draw():
    ...
    noFill()
    roundedRect(-wireg, -rh / 2 - wireh - wireg * 3 / 2,
                wireg * 2, wireg * 3.5, 30, 30)
    insetx = 15
    insety = 30
    yoff = 15
    fill(0)
    roundedRect(-wireg + insetx, -yoff - rh / 2 - wireh - wireg * 3 /
                2 + insety, wireg * 2 - 2 * insetx, wireg * 3.5 - 2 * insety, 30, 30)
    noFill()
